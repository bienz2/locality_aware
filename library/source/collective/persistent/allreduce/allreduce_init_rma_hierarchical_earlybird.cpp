                                 ...
                                 MPIL_Request** req_ptr)
{
    ...
    return allreduce_rma_multileader_earlybird_init_helper(sendbuf, recvbuf, count,
            datatype, op, comm, info, req_ptr, MPIL_Alloc, MPIL_Free);
                                 ...
                                 MPIL_Free_ftn free_ftn)
{
    ...
    return allreduce_rma_hierarchical_earlybird_init_core(sendbuf, recvbuf, count,
            datatype, op, comm->group_comm, comm->local_comm, tag,
            info, req_ptr, alloc_ftn, free_ftn);
}

int allreduce_rma_multileader_earlybird_init_helper(const void* sendbuf,
                                 void* recvbuf,
                                 int count,
                                 MPI_Datatype datatype,
                                 MPI_Op op,
